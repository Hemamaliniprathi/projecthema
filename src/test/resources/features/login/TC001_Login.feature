...
@Login
  Scenario Outline: Verify login with valid credentials without Enter Key
    ...
    Examples:
      ...
      | hemamalini.dhivya@gmail.com | Hemamalini@123 | Hemamalini       |
 
  Scenario Outline:
   Verify login with valid credentials using Enter Key via Robot Class
  ...
  Scenario Outline: Verify login with invalid credentials
    ...
    Examples:
      ...
      | User name    | Password   |
      | hemamalini.dhivya@gmail.com  | Hemamalini@123 |
